...
QASSA_VERSION := qassa-$(QASSA_BUILD_CODENAME)-$(QASSA_VERSION_NUMBER)-$(QASSA_BUILD)-$(QASSA_BUILD_DATE)-GApps
else
QASSA_VERSION := qassa-$(QASSA_BUILD_CODENAME)-$(QASSA_VERSION_NUMBER)-$(QASSA_BUILD)-$(QASSA_BUILD_DATE)-Vanilla
endif
