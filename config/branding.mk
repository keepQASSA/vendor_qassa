...
AOSQP_VERSION := AOSQP_$(AOSQP_VERSION_NUMBER)_$(AOSQP_BUILD)-GApps-$(AOSQP_BUILD_DATE)-QASSA
else
AOSQP_VERSION := AOSQP_$(AOSQP_VERSION_NUMBER)_$(AOSQP_BUILD)-Vanilla-$(AOSQP_BUILD_DATE)-QASSA
endif
