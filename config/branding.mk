...
QASSA_VERSION := qassa_$(QASSA_BUILD_CODENAME)-$(QASSA_VERSION_NUMBER)-$(QASSA_BUILD)-$(QASSA_BUILD_DATE)-GApps-signed
else
QASSA_VERSION := qassa_$(QASSA_BUILD_CODENAME)-$(QASSA_VERSION_NUMBER)-$(QASSA_BUILD)-$(QASSA_BUILD_DATE)-Vanilla-signed
endif
